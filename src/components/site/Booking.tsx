...
export function Booking() {
  ...
  const hasVagaro = Boolean(site.vagaroUrl);
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Intro {site.offers.intro.minutes} min ${site.offers.intro.price} ·
            Standard {site.offers.standard.minutes} min $
            {site.offers.standard.price} · {site.offers.pack.sessions}-pack $
            {site.offers.pack.price}. Book and pay in Vagaro. Unused pack
            sessions stay on your profile. Educational coaching only.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 max-w-xl">
          {hasVagaro ? (
            <Card className="border-border/80 shadow-sm">
              <CardHeader>
                <CardTitle className="text-xl">Book and pay on Vagaro</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Choose an intro (30 min), a standard session (60 min), or a
                  session pack. Vagaro handles the calendar, payment, and
                  remaining sessions.
                </p>
                <a
                  href={site.vagaroUrl}
